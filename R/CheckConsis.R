...
spconsis <- function(data, plot.size, width = 240){
  ...
  spconsis10(data) # Outliers detection based on interquartile range and values out of range for field data
  spconsis11(data) # Outliers detection based on interquartile range and values out of range for DM data
  spconsis12(data) # Outliers detection based on interquartile range and values out of range for cooked traits
  spconsis13(data) # Outliers detection based on interquartile range and values out of range for lab data
  spconsis14(data) # Outliers detection based on interquartile range and values out of range for derived variables
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 1: NOPS > NOPE > NOPH > NOPR.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 5: NOPR and number of roots.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 6: Number of roots and root weight.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 7: TRW, CRW+NCRW, NOCR+NONC, NOPR.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 10: Outliers detection based on interquartile range and values out of range for field data.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 11: Outliers detection based on interquartile range and values out of range for DM data.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 12: Outliers detection based on interquartile range and values out of range for cooked traits.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 13: Outliers detection based on interquartile range and values out of range for lab data.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
...
#'
#' Set of rules to check for consistency of sweetpotato experimental data.
#' Part 14: Outliers detection based on interquartile range and values out of range for derived variables.
#' @param data The name of the data frame.
#' @return It returns all rows with some kind of inconsistency and all rows with outliers
#' for internal use.
#' @author Raul Eyzaguirre.
